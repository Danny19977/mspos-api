...
func Setup(app *fiber.App) {
	...
	user.Get("/all/paginate/province/:id", userr.GetUserByProvinceID)
	user.Get("/all/paginate/sup/:id", userr.GetUserBySupID)
	...
	ar.Get("/all/paginate/province/:id", area.GetAreaByProvinceID)
	...
	posf.Get("/all/paginate/:id", posform.GetPosformByID)
	posf.Get("/all/paginate/province/:id", posform.GetPosformByProvinceID)
	posf.Get("/all/paginate/sup/:id", posform.GetPosformBySupID)
	...
	su.Get("/all/paginate/province/:id", sup.GetSupByProvinceID)
	...
	po.Get("/all/paginate/:id", poss.GetPosPaginateByID)
	po.Get("/all/paginate/province/:id", poss.GetPosByProvinceID)
	po.Get("/all/paginate/sup/:id", poss.GetPosBySupID)
	...
	userLog.Get("/all/paginate/:id", userlogs.GetUserLogByID)
